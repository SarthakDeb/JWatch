...
function TrendingMovies(){
    ...
    useEffect (() => {
        axios.get(`https://api.themoviedb.org/3/trending/movie/day?language=en-US&api_key=0b3672133712b849bac02b5ad9d496f2&page=${pageNo}`)
        .then((response)=>{
    ...
    return(
        <div>
            <div className="text-3xl font-bold p-4 text-amber-300">
                ...
                <h3 className="text-xl mt-2"> Here are the latest trending movies &#11162;</h3>
            </div>
