...
function Banner(){
    ...
    useEffect (() => {
    axios.get(`https://api.themoviedb.org/3/trending/movie/day?language=en-US&api_key=0b3672133712b849bac02b5ad9d496f2`)
    .then((response)=>{
        console.log(response.data.results)
        const firstMovieMeta = response.data.results[1];
